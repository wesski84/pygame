...
class Font:
    ...
    Default = pygame.font.SysFont("Calibri", 20)
    Small = pygame.font.SysFont("Calibri", 15)
    Medium = pygame.font.SysFont("Calibri", 40)
    Large = pygame.font.SysFont("Calibri", 60)
    Scanner = pygame.font.SysFont("Calibri", 30)
